...
# ///
"""Generate M4 input schemas: uv run scripts/generate_emr_schemas.py.
...
for name in (
    "EmrTemplateWriteRequest",
    "EmrRecordCreateRequest",
    "EmrRecordUpdateRequest",
    "AmendmentRequest",
    "ReviewRequest",
    "OrderItemInput",
    "OrderCreateRequest",
